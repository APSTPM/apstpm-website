...
export default function ContactPageContent({ locale, contactInfo }: ContactPageContentProps) {
  ...
  const contactDetails = [
    ...
    },
    {
      icon: MapPin,
      label: t('address'),
      value: isZh ? contactInfo.address : contactInfo.addressEn,
      href: null,
    },
  ];
                ...
                >
                  ...
                  <CardContent>
                    <p className="font-semibold text-gray-900">
                      {isZh ? org.data.name : org.data.nameEn}
                    </p>
                  </CardContent>
                </Card>
              ))}
